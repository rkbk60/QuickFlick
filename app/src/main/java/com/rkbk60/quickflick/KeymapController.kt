...
internal class KeymapController {
    ...
    private fun generateFnKeymap() {
        keymap.apply {
            ...
            put(1, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(7, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(8, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(14, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(15, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(21, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(22, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
            ...
            put(28, SpecialKeyCode.TOGGLE_ADJUSTMENT, up)
